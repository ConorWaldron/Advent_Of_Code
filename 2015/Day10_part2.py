...
This takes 2 seconds to run for part1 and 900 seconds for part 2
"""

import time


# idenitfy the first number
# count how many identical numbers follow that one, unitereptured
# move on to next number repeat (idenitfy next number, count how many
...
if __name__ == "__main__":
    ...
    solution = len(multiple_iterations(puzzle_input, 50))
